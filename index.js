...
const portfolioBtn = document.querySelectorAll('.portfiolio-btn');
 ...
 portfolioBtn.forEach(item =>{ 
        ...
        portfolioBtn.forEach(el=>{ el.classList.remove('span-visited'); });
...
function getTranslate(lang) {
  ...
  dataToTranslate.forEach((el) => el.textContent = i18Obj[lang][el.dataset.i18]);
};
...
const elemsToChangeColor = ['section-title', 
                             'skill-item',
                             '.skill-item-title',
                             '.skill-item-text',
